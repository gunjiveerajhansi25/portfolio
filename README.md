...
<body style="height:100vh;background-size:cover;">
    ...
    <h1 style="text-align:center;color:rgb(255, 20, 20)">GUNJI VEERAJHANSI</h1>
    ...
    <div class="card" style="margin-left:600px;background-color:aliceblue" >
        ...
        <a href="https://github.com/gunjiveerajhansi25"target="_blank">
    ...
    Hey!
    I'm GUNJI VEERAJHANSI from Andra Pradesh!
    I love programming, intrested on reading newspaper and learning new things!
    </pre>
</body>
